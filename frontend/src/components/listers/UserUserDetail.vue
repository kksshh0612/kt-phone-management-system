<template>
    <v-card outlined>
        ...
        <v-card-text>
            <div>
                <String label="LoginId" v-model="item.loginId" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="Authority" v-model="item.authority" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
